...
function ComplaintForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errMsg = err.response?.data?.error || err.response?.data?.message || 'Error submitting complaint. Please try again.';
    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={s.card}>
            <h3 style={s.cardTitle}>📷 Upload Image <span style={{ fontWeight: 400, fontSize: '13px', color: '#6b7280' }}>(optional)</span></h3>
            <div
              role="button"
              tabIndex={0}
          ...
          {/* Submit */}
          <button type="submit" style={submitting ? { ...s.submitBtn, opacity: 0.7 } : s.submitBtn} disabled={submitting}>
